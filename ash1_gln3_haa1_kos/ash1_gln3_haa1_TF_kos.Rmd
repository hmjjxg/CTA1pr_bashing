...
pi.dat <- data %>% 
  ...
  mutate(Genotype = fct_recode(genotype, `wt` = "wt", `ash1-` = "ash1_ko",  `gln3-` = "gln3_ko", `haa1-` = "haa1_ko")) %>% 
...
names(genotype_color) <- c("wt", "ash1-", "gln3-", "haa1-")
...
#ggsave("output/ash1_0Pi.png", width = 6.3, height = 8)
...
#ggsave("output/ash1_2mMH2O2.png", width = 6.3, height = 8)
```