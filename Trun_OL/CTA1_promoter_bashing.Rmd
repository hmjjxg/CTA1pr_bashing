...
ol.rel %>% 
  ...
  geom_bar_pattern(stat = "summary", fun = "mean",
                   ...
                   width=0.8) + 
  scale_fill_manual(values = c("#624185","#FF8C00")) +
  scale_pattern_manual(values = c(`0Pi` = "stripe", `2mMH2O2` = "none")) +
  geom_errorbar(stat = "summary", fun.data = mean_cl_boot, width = 0.2, color = "Red", linewidth = 1, position = position_dodge(width = .9)) +
  #stat_summary(fun.data = "mean_cl_boot", color = "Red", linewidth = 1, size = 0.8, position = position_dodge(width = .9)) +
  #geom_jitter(width = 0.2) +
...
#ggsave("output/OL_ori_rel_max.png", width = 9, height = 6)
...
ol.rel %>% 
  ...
  geom_bar_pattern(stat = "summary", fun = "mean",
                   ...
                   pattern_key_scale_factor = 1,
                   width=0.8) + 
  scale_fill_manual(values = c("#8e7cc3ff","#f6b26bff")) +
  scale_pattern_manual(values = c(`0Pi` = "stripe", `2mMH2O2` = "none")) +
  ...
  geom_hline(yintercept = 1, col = "gray", linetype = "dashed") +
  xlab("Internal removal (IR) variants") +
  ylab("max induction relative to wt (red)") +
  theme(strip.background = element_rect(colour="black", fill="white", size=1, linetype="solid"))
#ggsave("output/OL_deduct_rel_max.png", width = 12, height = 4)
...
ol.slope %>% 
  ...
  geom_hline(yintercept = 1, col = "gray", linetype = "dashed") +
  xlab("Internal removal (IR) variants") +
  ylab("maximum slope relative to wt") +
  theme(strip.background = element_rect(colour="black", fill="white", size=1, linetype="solid"))
#ggsave("output/OL_slope_rel_max.png", width = 12, height = 4)
