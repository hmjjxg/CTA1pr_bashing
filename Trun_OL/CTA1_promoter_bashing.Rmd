...
TrunV.rel <- bind_rows(pi.TrunV.dect.rel, oxi.TrunV.dect.rel)
...
```
### test epistasis effect between 600 - 800 bps and 800 to 1000 bps
```{r}
...
IR_610.pi <- TrunV.rel %>% filter(Genotype %in% c("IR_6.10", "WT"), Treatment == "0Pi", Time == "240min")
IR_610.oxi <- TrunV.rel %>% filter(Genotype %in% c("IR_6.10", "WT"), Treatment == "2mMH2O2", Time == "90min")
