...
tPs.main_effect <- read.csv("input/tPs_main_effect.csv", stringsAsFactors=FALSE) %>% mutate(main_effect = factor(main_effect, levels = levels))
...
tPs.main_effect %>% 
 ...
 geom_bar_pattern(stat = "summary", fun = "mean",
  ...
  theme(strip.background = element_rect(colour="black", fill="white", size=1, linetype="solid"), 
        legend.position= c(0.02, 0.9),
        axis.title.x=element_blank())
ggsave("output/tPs_main_effect_Plateau.png", width = 10.16, height = 2)
...
tPs.main_effect %>% 
 ...
 geom_bar_pattern(stat = "summary", fun = "mean",
  ...
  theme(strip.background = element_rect(colour="black", fill="white", size=1, linetype="solid"), 
        legend.position= "none",
        axis.title.x=element_blank())
ggsave("output/tPs_main_effect_max_slope.png", width = 10.16, height = 2)
...
tPs.main_effect %>% 
 ...
 geom_bar_pattern(stat = "summary", fun = "mean",
  ...
  theme(strip.background = element_rect(colour="black", fill="white", size=1, linetype="solid"), 
        legend.position= "none",
        axis.title.x=element_blank())
ggsave("output/tPs_main_effect_basal.png", width = 10.16, height = 2)
```
...
inter.main_effect <- read.csv("input/interaction_main_effect.csv", stringsAsFactors=FALSE) %>% mutate(main_effect = factor(main_effect, levels = inter.levels))
...
inter.main_effect %>% 
 ...
 geom_bar_pattern(stat = "summary", fun = "mean",
  ...
  theme(strip.background = element_rect(colour="black", fill="white", size=1, linetype="solid"), 
        legend.position= c(0.02, 0.9),
        axis.title.x=element_blank())
ggsave("output/inter_main_effect_Plateau.png", width = 10.16, height = 2)
...
inter.main_effect %>% 
 ...
 geom_bar_pattern(stat = "summary", fun = "mean",
  ...
  theme(strip.background = element_rect(colour="black", fill="white", size=1, linetype="solid"), 
        legend.position= "none",
        axis.title.x=element_blank())
ggsave("output/inter_main_effect_max_slope.png", width = 10.16, height = 2)
...
inter.main_effect %>% 
 ...
 geom_bar_pattern(stat = "summary", fun = "mean",
  ...
  theme(strip.background = element_rect(colour="black", fill="white", size=1, linetype="solid"), 
        legend.position= "none",
        axis.title.x=element_blank())
ggsave("output/inter_main_effect_basal.png", width = 10.16, height = 2)
```
